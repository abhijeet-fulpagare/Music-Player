...
const MainArea = ({ view, currentIndex, onSelectSong,
  onSelectFavourite, onSelectTag,
  songsToDisplay, setSearchSongs }) => {
  ...
  return (
    <div className="mainarea-root">
      ...
      <div className="mainarea-scroll">
        {(view === "home" || view === "search") && <SongList songs={songsToDisplay}
          onSelectSong={onSelectSong} currentIndex={currentIndex}
        />}
